 ...
 * @author harry
 */
public class ViewAbnormalSignsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewAbnormalSignsJPanel
     */
    private VitalSignHistory vsh;
    private double minBP, maxBP;
    public ViewAbnormalSignsJPanel(VitalSignHistory vsh, double minBP, double maxBP) {
        initComponents();
        this.vsh = vsh;
        this.minBP = minBP;
        this.maxBP = maxBP;
        populateAbnormalSigns();
    }
    
    public void populateAbnormalSigns(){
        DefaultTableModel dtm = (DefaultTableModel)vitalSignTable.getModel();
        dtm.setRowCount(0);
                
        for(VitalSigns vs : vsh.abnormalSignsList(minBP, maxBP)){
    ...
    private void initComponents() {
        ...
        viewLabel.setText("Abnormal Vital Signs");
        add(viewLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, -1, -1));
        ...
        add(dateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 420, 170, -1));
